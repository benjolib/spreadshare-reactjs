		...
		return (
				<div className="__page__container">
					<div className="__page__wrapper">
						<div id="solution">
							<p>Credit the Creators — Most sheet owners create a dedicated tab to inform the users about the aim, methodology, sources, rules, creators (…) of a spreadsheet. When looking into our data we realized that we couldn’t identify the owners of 56% of the spreadsheets submitted to our platform. Creators, contributors and users are anonymous, you can’t credit, follow or pledge them. At Wikipedia we can see that reputation seems to be the most important motivator to contribute knowledge. That’s why we put the creators and contributors first, offer ways to pledge and follow them, and let them build up their reputation. Another great side effect is that a creators reputation is a very good indicator for the quality of the creation, too.</p>
							<br />
